<template>
  <div>
    ...
    <div class="container px-4" v-if="canCreateGroup">
            ...
            <div class="card-body">
              <div class="form-group row">
                ...
                <div class="col-sm-12 text-right">
                  ...
                  <button class="btn btn-secondary" v-else>
                    Submitting...
                  </button>
                </div>
              </div>
            ...
            <div class="card-body">
              <div class="card-body">
                <div class="card-header">
                  Access denied. Please contact your moderator or admin to gain
                  access
                </div>
              </div>
            </div>
  ...
  methods: {
    canCreateGroup() {
      return (
        ...
        this.user.loggedIn &&
        this.user.data &&
        (this.user.data.admin || this.user.data.moderator)
      );
    },
